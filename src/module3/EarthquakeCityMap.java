...
public class EarthquakeCityMap extends PApplet {
	...
	public static final float MODERATE = 5;
	// Less than this threshold is a minor earthquake
	public static final float LIGHT = 4;
	...
	*/
	...
	{  
		...
		else if((int)mag < LIGHT) {
			marker.setColor(blue);
			marker.setRadius(5);

		}
		else if(mag>=LIGHT && mag<MODERATE) {
			marker.setRadius(10);
	...
	{	
		...
		fill(150,150,150);
		rect(25, 50, 150, 200, 15);
		fill(0, 50, 255);
		text("Earthquake Key", 30, 75);
		fill(255, 0, 0);
		ellipse(45, 100, 15, 15);
		fill(255,255,255);
		text(":   5.0+ Magnitude", 60 , 104);
	
		fill(255, 255, 0);
		ellipse(45, 150, 10, 10);
		fill(255,255,255);
		text(":   4.0+ Magnitude", 60 , 154);
		
		fill(0, 0, 255);
		ellipse(45, 200, 7, 7);
		fill(255,255,255);
		text(":   Below 4.0", 60 , 204);
	}
}
